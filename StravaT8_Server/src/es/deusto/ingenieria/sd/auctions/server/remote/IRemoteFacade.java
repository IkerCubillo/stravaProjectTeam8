...
import es.deusto.ingenieria.sd.auctions.server.data.dto.TrainingSessionDTO;
	...
	public interface IRemoteFacade extends Remote {	
		...
		public void register(String account, String email, String password, String name, Date birthDate, float weight, float height, int mBPM, int bpm) throws RemoteException;
